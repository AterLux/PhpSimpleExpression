...
* Неявное строковая конкатенация (выражения без оператора между ними рассматриваютися как конкатенация их строковых значений)
* Скобки
* Вызовы функций
...
1. Неявная **строковая конкатенация** (если между выражениями нет оператора);
